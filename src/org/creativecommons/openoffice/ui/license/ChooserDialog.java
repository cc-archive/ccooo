...
public class ChooserDialog {
    ...
    public void showDialog() throws com.sun.star.uno.Exception {
        ...
        xPSetFaqButton.setPropertyValue("PositionY", new Integer(100));
        xPSetFaqButton.setPropertyValue("Width", new Integer(40));
        xPSetFaqButton.setPropertyValue("Height", new Integer(14));
        xPSetFaqButton.setPropertyValue("Name", BTN_FAQ);
    ...
    public License getSelectedLicense() {
        ...
        return licenseChooser.selectLicense(
                this.getCheckboxValue(ChooserDialog.CHK_ALLOW_REMIX).booleanValue(),
                this.getCheckboxValue(ChooserDialog.CHK_PROHIBIT_COMMERCIAL).booleanValue(),
                this.getCheckboxValue(ChooserDialog.CHK_REQUIRE_SHAREALIKE).booleanValue(),
    ...
    public void setSelectedLicense(License selected) {
        ...
        this.setCheckboxValue(ChooserDialog.CHK_ALLOW_REMIX, selected.allowRemix());
        this.setCheckboxValue(ChooserDialog.CHK_PROHIBIT_COMMERCIAL, selected.prohibitCommercial());
        this.setCheckboxValue(ChooserDialog.CHK_REQUIRE_SHAREALIKE, selected.requireShareAlike());
