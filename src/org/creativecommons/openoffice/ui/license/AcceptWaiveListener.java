    ...
    public void itemStateChanged(ItemEvent event) {
        ...
        try {
            ...
            if (allow_Remixing.getState() == (short) 0) {
                ...
                ((XPropertySet) UnoRuntime.queryInterface(XPropertySet.class,
                        this.getDialog().getNameContainer().getByName(ChooserDialog.CMB_TERRITORY))).setPropertyValue("Enabled", Boolean.FALSE);
                ((XPropertySet) UnoRuntime.queryInterface(XPropertySet.class,
                ...
                ((XPropertySet) UnoRuntime.queryInterface(XPropertySet.class,
                        this.getDialog().getNameContainer().getByName(ChooserDialog.CMB_TERRITORY))).setPropertyValue("Enabled", Boolean.TRUE);
            }
