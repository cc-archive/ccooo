 ...
 * @author akila
 */
public class OpenClipArtConnection_Old {

    public final static OpenClipArtConnection_Old instance = new OpenClipArtConnection_Old();
    public final static ArrayList<Image> imgList = new ArrayList<Image>();

    protected OpenClipArtConnection_Old() {
    }
    ...
    public ArrayList<Image> searchPhotos(String[] tags, int currentPage) {
        ...
        try {
            ...
            Logger.getLogger(OpenClipArtConnection_Old.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                in.close();
            } catch (IOException ex) {
