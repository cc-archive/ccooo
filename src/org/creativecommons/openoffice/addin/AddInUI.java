...
public class AddInUI {
     ...
     */
    public AddInUI(AddIn addon, XComponentContext m_xContext) {
    ...
    public void createDialog() throws com.sun.star.uno.Exception {
        ...
        xNextButton.addActionListener(new OnNextClick(xControlCont,xPSetDialog,this));
        ...
        xFinishButton.addActionListener(new OnFinishClick(this.addon, this));
        ...
        xCancelButton.addActionListener(new OnCancelClick(xControlCont,xPSetDialog, this));
        ...
        List classes = (List)AddIn.ccr.licenseClasses("en");
        ...
        lb.addItemListener(new OnSelectLicenceClass(xControlCont, this));
    ...
    public void selectClass(String id) {
        ...
        List fields = (List)this.addon.ccr.fields(id);
...
class OnSelectLicenceClass implements XItemListener {
    ...
    public  OnSelectLicenceClass(XControlContainer xControlCont, AddInUI ui){
...
class OnNextClick implements XActionListener {
    ...
    public  OnNextClick(XControlContainer xControlCont, XPropertySet xPSetDialog, AddInUI ui){
        this._xControlCont = xControlCont;
    ...
    public void actionPerformed(ActionEvent a ) {
        ...
        try {
            ...
            if (step == 1) {
                ...
                XTextComponent t = (XTextComponent)UnoRuntime.queryInterface(
                        XTextComponent.class, _xControlCont.getControl("Class"));
                this.ui.selectClass(AddIn.ccr.getLicenseId(t.getText()));
                
                this._xPSetDialog.setPropertyValue("Step", ++step);
                
                // Enable Previous Button
                ((XWindow)UnoRuntime.queryInterface(
                        XWindow.class, this._xControlCont.getControl(this.ui.previousButtonName))).setEnable(true);
                
                // Disable next button
                ((XWindow)UnoRuntime.queryInterface(
                        XWindow.class, this._xControlCont.getControl(this.ui.nextButtonName))).setEnable(false);
...
class OnCancelClick implements XActionListener {
    ...
    public  OnCancelClick(XControlContainer xControlCont, XPropertySet xPSetDialog, AddInUI ui){
        this._xControlCont = xControlCont;
        this._xPSetDialog = xPSetDialog;
        this.ui = ui;
    }
...
class OnFinishClick implements XActionListener {
    ...
    public  OnFinishClick(AddIn addon, AddInUI ui){
    ...
    public void actionPerformed(ActionEvent a ) {
        try {
            ...
            AddIn.ccr.issue(this.ui.currentId, this.ui.answers, "en");
            
            String licenseName = AddIn.ccr.getLicenseName();
            String licenseURL =  AddIn.ccr.getLicenseUrl();
            String licenseImageURL = AddIn.ccr.getLicenseImageURL();
            
            this.addon.createAutoText(licenseName,licenseURL, licenseImageURL);
            
            this.addon.insertLicenseMetadata(licenseName,licenseURL);
